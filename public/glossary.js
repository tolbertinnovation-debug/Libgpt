...
export const GLOSSARY = {
  ...
  'palaver': 'A dispute, a long discussion, or trouble that will not settle.',
  'country fashion': 'Ancestral heritage — traditional medicine, custom and the proper old way of doing a thing.',
  'eat money': 'To spend recklessly, or to misuse money that was held for other people.',
  'the thing dem': 'The things — a general way of referring to whatever is being discussed.',
  'fast-fast': 'Quickly; in a hurry.',
  'big-big': 'Grand; important; on a large scale.',
  'one-one': 'One at a time.',
  'now-now': 'Right now; immediately.',
  'papay': 'Respectful address for an older man.',
  'ma': 'Respectful address for an older woman.',
  'vex': 'Angry; annoyed.',
  'carry': 'To take something somewhere — "carry it to the office".',
  'reach': 'To arrive — "when you reach the junction".',
